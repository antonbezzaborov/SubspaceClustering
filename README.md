...
Оптимизированная реализация алгоритма Subspace Clustering K-Means. Проект направлен на решение фундаментальной проблемы машинного обучения — **Curse of Dimensionality** при анализе многомерных данных.
...
Сравнительный анализ устойчивости алгоритмов при последовательном добавлении **до 700 шумовых измерений**. 
